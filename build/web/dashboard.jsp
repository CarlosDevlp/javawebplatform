<%-- 
    Document   : index
    Created on : oct 9, 2017, 6:35:02 a.m.
    Author     : JUAN
--%>
...
<%
    ...
    {    
        response.sendRedirect("http://localhost:8080/PreT3/index.jsp");
    }
    else{
        username=(String) session.getAttribute("usuarioLogeado");
    }
                    ...
                    <nav class="navbar navbar-inverse navbar-static-top">
                        <div class="container-fluid">
                            ...
                            <header class="navbar-header">
                                ...
                                <a href="index2.html" class="navbar-brand"><img src="assets/img/logo.png" alt=""></a>
                            ...
                            <div class="topnav">
                                ...
                                <div class="btn-group">
                                    <a href="index3.html" data-toggle="tooltip" data-original-title="Logout" data-placement="bottom"
